...
<!-- NavBar -->
	...
	<div class='bg-slate-500 p-4 rounded'>
		...
		<% } %>
	<form method='POST' action='debitAction.jsp'>
		...
		<div class="mt-2 max-w-sm mx-auto"> 
		  	<label for="debitAmt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Debit Amount</label>
  			<input type="text" name="debitAmt" aria-describedby="helper-text-explanation" 
