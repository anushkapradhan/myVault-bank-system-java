...
<!-- NavBar -->
	...
	<div class='bg-slate-500 p-4 rounded'>
		...
		<% } %>
	<form method='POST' action='creditAction.jsp'>
		<div class="max-w-sm mx-auto"> 
			<div class='mx-20 flex mt-8 text-red-900 font-bold justify-center'>
			...
			<div class='flex text-blue-900 text-xl font-bold mt-5 text-center'>
				<p class='flex-1'>Credit Amount</p>
			</div>
		</div>
		...
		<div class="mt-2 max-w-sm mx-auto"> 
		  	<label for="creditAmt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Credit Amount</label>
  			<input type="text" name="creditAmt" aria-describedby="helper-text-explanation" 
